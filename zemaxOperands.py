...
class Operands(object):
    ...
    "CODA":"Coating Data.",
    "COGT":"Boundary operand that constrains the conic of the surface to be greater than the specified target value.",
    "COLT":"Boundary operand that constrains the conic of the surface to be less than the specified target value.",
    "COMA":"Coma in waves contributed by the surface defined by Surf at the wavelength defined by Wave.",
    "CONF":"Configuration.",
    "CONS":"Constant value.",
    "COSA":"Unused.",
    ...
    "DIST":"Distortion in waves contributed by the surface defined by Surf at the wavelength defined by Wave. See also DISG.",
    "DIVB":"Divides the value of any prior operand defined by Op# by any factor defined by Factor.",
    "DIVI":"Division of first by second operand (Op#1 / Op#2). See also 'RECI'.",
    "DLTN":"Delta N. Computes the diff. between the max & min index of refraction on axis for a gradient index surface.",
    ...
    "EFLX":"Effective focal length in the local x plane of the range of surfaces defined by Surf1 and Surf2 at the primary wavelength.",
    "EFLY":"Effective focal length in the local y plane of the range of surfaces defined by Surf1 and Surf2 at the primary wavelength.",
